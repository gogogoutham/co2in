...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CO2IN " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"co2intools.com", "dnsseed.co2intools.com"},
    {"co2inpool.org", "dnsseed.co2inpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"co2intools.com", "testnet-seed.co2intools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CO2IN is probably already running."), addrBind.ToString().c_str());
        else
